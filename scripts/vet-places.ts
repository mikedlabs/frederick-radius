 ...
 *
 * Pricing (2026-08): Place Details, our lean field mask = Enterprise
 * $20.00 / 1,000, with 1,000 free requests per month. A 2,400-place
 * sweep would be about $28 after that free cap.
 */
...
async function main() {
  ...
  const targets = allSlugs.slice(0, run.limit);
