...
const LINKS = {
  resident: {
    ...
    tiles: [
      ...
      { href: "/explore?mode=radius", label: "Open near me", sub: "What's open around you", Icon: Navigation, c: "var(--app-brand)" },
      { href: "/explore", label: "On the map", sub: "Parking, amenities, trash", Icon: MapIcon, c: "var(--app-positive, #1E6B3A)" },
