...
function BrandPip({ meta, size = "sm" }: { meta: ReturnType<typeof sourceMeta>; size?: "sm" | "md" }) {
  const dim = size === "md" ? "h-9 w-9 text-[11px]" : "h-7 w-7 text-[11px]";
  return (
    <span
      aria-hidden
          ...
          <div className="flex items-start gap-3 px-4 py-4 pl-5">
            ...
            <div className="min-w-0 flex-1">
              <div className="mb-1.5 flex items-center gap-2">
                <span
                  className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-bold uppercase tracking-[0.1em]"
                  style={{
