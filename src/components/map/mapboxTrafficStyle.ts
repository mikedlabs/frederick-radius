...
> = {
  ...
  "line-width": ["interpolate", ["linear"], ["zoom"], 8, 1.25, 12, 2.6, 16, 5.5],
  "line-offset": ["interpolate", ["linear"], ["zoom"], 8, 1, 12, 2, 16, 4],
  "line-opacity": 0.88,
};
...
> = {
  "line-color": "#A92F2B",
  "line-width": ["interpolate", ["linear"], ["zoom"], 8, 2, 12, 3.5, 16, 6.5],
  "line-offset": ["interpolate", ["linear"], ["zoom"], 8, 1.25, 12, 2.5, 16, 4.5],
