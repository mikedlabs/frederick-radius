...
import { type SelectedStop } from "@/components/transit/StopArrivalsPopup";
  ...
  return (
    ...
    >
      ...
      {fullBleed && !dock && events.length > 0 && (
        ...
        <AppMapSelectionSurfaces
          dock={dock}
          compactMapViewport={compactMapViewport}
          selectedDiscovery={selectedDiscovery}
          selectedDiscoveryIndex={selectedDiscoveryIndex}
          discoveryDeckLength={discoveryDeck.length}
          showDiscoveryAt={showDiscoveryAt}
          selectedEvent={selectedEvent}
          selected={selected}
          rawSelectionContext={rawSelectionContext}
          civicTown={civicTown}
          selectedAerial={selectedAerial}
