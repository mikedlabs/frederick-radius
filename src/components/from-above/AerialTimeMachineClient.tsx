        ...
        <section className="w-full max-w-md space-y-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Link
              ...
              className="inline-flex min-h-11 items-center rounded-full px-4 py-2 text-[13px] font-semibold"
            ...
            <Link
              href="/compass"
              className="inline-flex min-h-11 items-center rounded-full border px-4 py-2 text-[13px] font-semibold"
