...
function Pint({ color }: { color: FamilyColor }) {
  return (
    <>
      ...
      <path d="M42.4 80 C46 66 58 62 64 72 C68 60 82 58 87 70 C92 58 106 60 109 72 C114 62 126 64 130 74 C133 77 135.6 78.5 137.6 80" strokeWidth={CONTOUR - 1} />
...
function Pilsner({ color }: { color: FamilyColor }) {
  return (
    <>
      ...
      <path d="M48.8 82 C52 69 63 65 68.5 74.5 C72.5 63 86 61 90.5 72.5 C95 61 108 63 111 74.5 C116 66 126 68 129 77 C130 79 130.6 80.5 131.2 82" strokeWidth={CONTOUR - 1} />
  ...
  return (
    <>
      ...
      <path
        ...
        strokeWidth={CONTOUR}
      />
      <path d="M49 66 C52.5 54 63 51 68.5 60.5 C72.5 50 85.5 48.5 90 59.5 C94.5 48.5 107 50.5 110.5 61 C115.5 53.5 125 56 128.5 63.5 C129.5 64.5 130.3 65.2 131 66" strokeWidth={CONTOUR - 1} />
  ...
  return (
    <>
      ...
      <path
        ...
        strokeWidth={CONTOUR}
      />
      <path d="M48.2 78 C51.5 66 62 63 67.5 72 C71.5 61.5 85 60 89.5 71 C94 60 106.5 62 110 73 C115 65.5 125 67.5 128.5 75 C129.7 76.2 130.8 77.1 131.8 78" strokeWidth={CONTOUR - 1} />
