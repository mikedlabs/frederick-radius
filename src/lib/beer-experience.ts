...
export const TASTE_PATHS: readonly TastePath[] = [
  {
    ...
    label: "Hoppy & hazy",
    shortLabel: "Hoppy",
    description: "Citrus, pine, soft haze and a little bite.",
  ...
  },
  {
    ...
    label: "Crisp & easy",
    shortLabel: "Crisp",
    description: "Clean lagers and balanced, everyday pours.",
  ...
  },
  {
    ...
    label: "Dark & roasty",
    shortLabel: "Dark",
    description: "Coffee, chocolate, caramel and toasted malt.",
  ...
  },
  {
    ...
    label: "Tart & unusual",
    shortLabel: "Tart",
    description: "Sours, fruit, oddballs and the unexpected.",
  ...
  },
  {
    ...
    description: "Dry, rustic, spicy and yeast-driven.",
