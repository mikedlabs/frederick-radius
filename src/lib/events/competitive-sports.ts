...
const NON_COMPETITIVE_TITLE =
  /\b(?:board game|game night|poker|bingo|trivia|tickets?|bible study|camps?|clinics?|classes?|lessons?|workshops?|fundraisers?|fundraising|skills?(?:\s+(?:camp|session|training))?|sports night|watch part(?:y|ies)|tailgates?|tryouts?|registration|open house|open play|pep rally|banquets?|hot dogs?)\b/i;
