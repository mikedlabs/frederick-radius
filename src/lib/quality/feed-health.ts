...
export const RUNTIME_SOURCE_ENDPOINTS: readonly FeedHealthEndpoint[] = [
  {
    group: "City of Frederick sidewalks",
    sourceId: "cof_sidewalks",
    url: "https://spires.cityoffrederick.com/arcgis/rest/services/Sidewalks/MapServer?f=json",
    critical: false,
    method: "GET",
    maxBodyBytes: 4_096,
    contentType: /json|text\/plain/i,
    bodyPattern: /"layers"\s*:|"mapName"\s*:\s*"Sidewalks"/i,
    accept: "application/json, text/plain",
  },
  {
    group: "City of Frederick Path Plan",
    sourceId: "cof_path_plan",
    url: "https://spires.cityoffrederick.com/arcgis/rest/services/PathPlan/MapServer?f=json",
    critical: false,
    method: "GET",
    maxBodyBytes: 4_096,
    contentType: /json|text\/plain/i,
    bodyPattern: /"layers"\s*:|"mapName"\s*:/i,
    accept: "application/json, text/plain",
  },
  {
    group: "City of Frederick capital projects",
    sourceId: "cof_capital_improvement",
    url: "https://spires.cityoffrederick.com/arcgis/rest/services/CapitalImprovementProjects/MapServer?f=json",
    critical: false,
    method: "GET",
    maxBodyBytes: 4_096,
    contentType: /json|text\/plain/i,
  ...
  {
    group: "City of Frederick development review",
    sourceId: "cof_development_review",
    url: "https://spires.cityoffrederick.com/arcgis/rest/services/DevelopmentReview/MapServer?f=json",
    critical: false,
    method: "GET",
    maxBodyBytes: 4_096,
    contentType: /json|text\/plain/i,
  ...
  {
    group: "Maryland SHA active road closures",
    sourceId: "md_sha_road_closures",
    url: "https://mdgeodata.md.gov/appdata/rest/services/SHA_RoadClosure/RoadClosureActive/MapServer?f=json",
    critical: false,
    method: "GET",
    maxBodyBytes: 4_096,
    contentType: /json|text\/plain/i,
    bodyPattern: /"currentVersion"\s*:|"layers"\s*:/i,
    accept: "application/json, text/plain",
  },
  {
    group: "Maryland WZDx",
