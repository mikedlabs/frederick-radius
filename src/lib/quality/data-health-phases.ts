...
const EVENT_ARCHIVE_DIAGNOSTIC =
  /^Archive checks failed: (?:schema-not-ready|source-read|unified-events|unified-partial|live-events|live-partial|live-empty|no-public-events|no-archivable-events|archive-write|archive-cleanup|archive-incomplete|archive-truncated)(?:, (?:schema-not-ready|source-read|unified-events|unified-partial|live-events|live-partial|live-empty|no-public-events|no-archivable-events|archive-write|archive-cleanup|archive-incomplete|archive-truncated))*\.$/;
