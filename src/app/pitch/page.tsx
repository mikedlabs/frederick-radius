  ...
  return (
    <main id="main-content" tabIndex={-1} className="bg-[#030014] min-h-screen text-white overflow-hidden">
      <aside
        ...
        className="fixed left-3 right-24 top-3 z-[60] rounded-2xl border border-amber-300/25 bg-[#100b24]/90 px-3 py-2 text-[10px] font-medium leading-tight text-amber-50 shadow-2xl backdrop-blur-xl sm:left-1/2 sm:right-auto sm:max-w-[min(760px,calc(100vw-10rem))] sm:-translate-x-1/2 sm:rounded-full sm:px-5 sm:text-center sm:text-xs"
      >
