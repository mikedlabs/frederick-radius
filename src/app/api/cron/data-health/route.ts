...
async function runDataHealthReport() {
  ...
  return NextResponse.json({
    ...
    food_truck_schedules: {
      ...
      tracked_sources: foodTruckScheduleHealth.trackedSources,
      successful_sources: foodTruckScheduleHealth.successfulSources,
      productive_sources: foodTruckScheduleHealth.productiveSources,
      retained_stop_count: foodTruckScheduleHealth.retainedStopCount,
      vendor_mentions: foodTruckScheduleHealth.vendorMentions,
      canonical_vendor_links: foodTruckScheduleHealth.canonicalVendorLinks,
      canonical_link_rate_pct: foodTruckScheduleHealth.canonicalLinkRatePct,
      last_success_at: foodTruckScheduleHealth.lastSuccessAt,
      failed_sources: foodTruckScheduleHealth.failedSources,
      suspicious_zero_sources: foodTruckScheduleHealth.suspiciousZeroSources,
      suspicious_drop_sources: foodTruckScheduleHealth.suspiciousDropSources,
