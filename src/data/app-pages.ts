...
export const APP_PAGES: AppPage[] = [
  ...
  { href: "/beer", title: "Frederick beer guide", blurb: "Browse 174 signature pours from 17 listed breweries, or save visited taprooms in a device-only passport.", keywords: ["beer", "brewery", "breweries", "taproom", "pour"] },
  ...
  { href: "/numbers", title: "The county, counted", blurb: "See counts calculated from the shipped Frederick Radius datasets.", keywords: ["numbers", "stats", "statistics", "how many", "almanac", "counted"] },
