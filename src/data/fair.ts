...
export const FAIR_MAP_POIS: FairPOI[] = [
  {
    ...
    description: "Enjoy concerts, the Demolition Derby, and Motorsports.",
  },
  {
    id: "dairy-bar",
    name: "The Dairy Bar",
    ...
    description: "Enjoy famous fair milkshakes and ice cream.",
  },
  {
    id: "hemps-meats",
    name: "Hemp's Meats",
    ...
    description: "Find pit beef, ham, and turkey.",
  },
  {
    id: "midway",
    name: "The Midway",
    ...
    description: "Ride carnival rides and play games.",
  },
  {
    id: "agri-plex",
    ...
    description: "See vendor exhibits and agriculture displays.",
  },
  {
    id: "beef-barn",
    ...
    description: "See the livestock exhibits.",
  },
  {
    id: "gate-1",
