...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    subcategories: ["pizza"],
    tags: ["date-night"],
    short_blurb: "Chef Marco Pontecorvo's Neapolitan brick-oven pizza and southern Italian cooking on Presidents Court.",
    ...
    commerce_links: [
      {
        ...
        notes: "OpenTable profile checked 2026-07-17: bookable, address matches.",
      },
    ],
    price_band: 3,
  ...
  },
  {
    ...
    category: "restaurant",
    short_blurb: "Frederick Community College's student-run restaurant. Three-course Thursday dinners cooked and served by the culinary program, reservations required.",
    ...
    commerce_links: [
      {
        ...
        source: "curated",
        last_verified_at: "2026-07-17",
        notes: "OpenTable profile checked 2026-07-17: bookable (Thursday seatings), address matches.",
      },
    ],
    price_band: 3,
    is_verified: false, hours_verified: false, is_operational: "operational",
  ...
  },
  {
    ...
    name: "Bonefish Grill",
    category: "restaurant",
    short_blurb: "Wood-grilled fish and the Bang Bang Shrimp in the 7th Street shopping center.",
    address: "1305 W 7th St",
  ...
  },
  {
    ...
    category: "restaurant",
    tags: ["family"],
    short_blurb: "Big-menu brewhouse chain by Westview: house beers, deep-dish pizza, and the Pizookie dessert.",
