...
export const CATEGORIES: Category[] = [
  { slug: "food", name: "Eat & drink", icon: "Utensils", color: "#E14328", display_order: 10, blurb: "Restaurants, cafes, bars, and breweries include current hours when available." },
  { slug: "restaurant", name: "Restaurants", parent: "food", icon: "UtensilsCrossed", color: "#E14328", display_order: 11, blurb: "The restaurant guide runs from quick meals to special-occasion dining." },
  ...
  { slug: "brewery", name: "Breweries", parent: "food", icon: "Beer", color: "#C0871F", display_order: 14, blurb: "Independent local breweries appear with their taprooms and beer gardens." },
  ...
  { slug: "bakery", name: "Bakeries", parent: "food", icon: "Cookie", color: "#B26B00", display_order: 15, blurb: "Local bakeries cover bread, pastries, and early-morning favorites." },
  { slug: "pizza", name: "Pizza", parent: "food", icon: "Pizza", color: "#E14328", display_order: 16, blurb: "The pizza list runs from quick slices to wood-fired pies." },
  ...
  { slug: "food-truck", name: "Food trucks", parent: "food", icon: "Truck", color: "#E14328", display_order: 17.5, blurb: "Recurring stops and larger food-truck events appear when a reliable schedule is available." },

  { slug: "outdoors", name: "Parks & trails", icon: "Trees", color: "#1E6B3A", display_order: 20, blurb: "Parks, trails, playgrounds, water access, and scenic overlooks come together here." },
  { slug: "park", name: "Parks", parent: "outdoors", icon: "Trees", color: "#1E6B3A", display_order: 21, blurb: "Public parks span Frederick County's municipalities and unincorporated communities." },
  { slug: "trail", name: "Trails", parent: "outdoors", icon: "Mountain", color: "#16352B", display_order: 22, blurb: "County trails include wooded hikes, towpaths, and rail-trails." },
  { slug: "playground", name: "Playgrounds", parent: "outdoors", icon: "ToyBrick", color: "#1E6B3A", display_order: 23, blurb: "Public playgrounds are mapped for quick nearby trips." },
  ...
  { slug: "arts", name: "Arts & culture", icon: "Palette", color: "#7E2C6F", display_order: 30, blurb: "Galleries, theaters, museums, and performance spaces make up this section." },
  ...
  { slug: "gallery", name: "Galleries", parent: "arts", icon: "ImageIcon", color: "#7E2C6F", display_order: 32, blurb: "Independent galleries and First Friday exhibition spaces appear here." },
  ...
  { slug: "music", name: "Live music", parent: "arts", icon: "Music", color: "#7E2C6F", display_order: 34, blurb: "These venues regularly host live music or seasonal outdoor series." },
  ...
  { slug: "tours", name: "Tours & rides", parent: "arts", icon: "BusFront", color: "#7E2C6F", display_order: 36, blurb: "Local tours include double-decker rides, heritage rail excursions, and guided walks." },

  { slug: "family", name: "Family", icon: "Baby", color: "#C0871F", display_order: 40, blurb: "Places and events appear here when the available source supports a family-friendly claim.", see_also: ["playground"] },
  { slug: "library", name: "Libraries", parent: "family", icon: "Library", color: "#20506A", display_order: 41, blurb: "Frederick County Public Libraries branches offer programs and public amenities." },
  ...
  { slug: "shopping", name: "Shopping", icon: "ShoppingBag", color: "#B26B00", display_order: 50, blurb: "Independent shops and Main Street businesses appear throughout the county." },
  ...
  { slug: "voting", name: "Voting", parent: "civic", icon: "Vote", color: "#20506A", display_order: 73, blurb: "Election-day and early-voting centers appear with their published details.", kind: "utility" },
  ...
  { slug: "pharmacy", name: "Pharmacies", parent: "services", icon: "Pill", color: "#1E6B3A", display_order: 81, blurb: "The directory includes independent and chain pharmacies." },
  ...
  { slug: "transit", name: "Transit", icon: "Train", color: "#20506A", display_order: 95, blurb: "Transit listings cover county buses, MARC rail, and local stations." },
  ...
  { slug: "amenities", name: "Amenities", icon: "PinCircle", color: "#20506A", display_order: 100, blurb: "The map brings together restrooms, water, seating, waste stations, and other public infrastructure." },
  { slug: "restroom", name: "Public restrooms", parent: "amenities", icon: "DoorOpen", color: "#20506A", display_order: 101, blurb: "Mapped public restrooms include facilities in parks, libraries, and downtown." },
  { slug: "water", name: "Drinking water", parent: "amenities", icon: "Droplets", color: "#20506A", display_order: 102, blurb: "Mapped water points include drinking fountains and bottle-filling stations." },
  ...
  { slug: "recycling", name: "Recycling drop-offs", parent: "amenities", icon: "Recycle", color: "#1E6B3A", display_order: 104, blurb: "Public recycling drop-off locations are shown when mapped." },
  { slug: "dog-waste", name: "Dog waste stations", parent: "amenities", icon: "PawPrint", color: "#1E6B3A", display_order: 105, blurb: "Mapped dog stations include bag dispensers and waste bins." },
  { slug: "dog-water", name: "Dog water", parent: "amenities", icon: "PawPrint", color: "#20506A", display_order: 105.5, blurb: "Mapped dog-water bowls and fountains appear here." },
  ...
  { slug: "wifi", name: "Public WiFi", parent: "amenities", icon: "Wifi", color: "#20506A", display_order: 106, blurb: "Libraries, parks, and businesses that advertise free public Wi-Fi are included." },
  ...
  { slug: "picnic", name: "Picnic areas", parent: "amenities", icon: "Utensils", color: "#1E6B3A", display_order: 107, blurb: "Mapped picnic areas include tables, shelters, and grilling spots." },
  { slug: "bike-parking", name: "Bike parking", parent: "amenities", icon: "Bike", color: "#20506A", display_order: 108, blurb: "Mapped bike parking includes racks and corrals." },
  { slug: "bike-repair", name: "Bike repair stations", parent: "amenities", icon: "Wrench", color: "#20506A", display_order: 109, blurb: "Mapped fix-it stations include public tools and air pumps." },
