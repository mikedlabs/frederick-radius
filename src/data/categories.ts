...
export const CATEGORIES: Category[] = [
  ...
  { slug: "trail", name: "Trails", parent: "outdoors", icon: "Mountain", color: "#2E3B2C", display_order: 22, blurb: "200+ miles of hikes, towpaths, and rail-trails." },
  ...
  { slug: "family", name: "Family", icon: "Baby", color: "#C99632", display_order: 40, blurb: "Kid-friendly places, family-rated events, indoor rainy-day picks." },
  { slug: "library", name: "Libraries", parent: "family", icon: "Library", color: "#2F5470", display_order: 41, blurb: "County branches, story times, free wifi, and community rooms." },
  ...
  { slug: "transit", name: "Transit", icon: "Train", color: "#2F5470", display_order: 95, blurb: "TransIT bus, MARC rail, and stations." },
  ...
  { slug: "amenities", name: "Amenities", icon: "PinCircle", color: "#2F5470", display_order: 100, blurb: "Restrooms, water, dog stations, benches, picnic, bike parking — out in public." },
  { slug: "restroom", name: "Public restrooms", parent: "amenities", icon: "DoorOpen", color: "#2F5470", display_order: 101, blurb: "Public restrooms in parks, libraries, and downtown." },
  { slug: "water", name: "Drinking water", parent: "amenities", icon: "Droplets", color: "#2F5470", display_order: 102, blurb: "Public drinking fountains and water bottle refill points." },
  ...
  { slug: "wifi", name: "Public WiFi", parent: "amenities", icon: "Wifi", color: "#2F5470", display_order: 106, blurb: "Free public internet — libraries, parks, and spots that publish open WiFi." },
  ...
  { slug: "bike-parking", name: "Bike parking", parent: "amenities", icon: "Bike", color: "#2F5470", display_order: 108, blurb: "Bike racks and corrals." },
  { slug: "bike-repair", name: "Bike repair stations", parent: "amenities", icon: "Wrench", color: "#2F5470", display_order: 109, blurb: "Public fix-it stations with tools and air pumps." },
