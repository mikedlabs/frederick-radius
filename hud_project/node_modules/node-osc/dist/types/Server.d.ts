...
import node_events = require('node:events');
import type Message from './Message.mjs';
import type Bundle from './Bundle.mjs';
/**
 ...
 * });
 */
declare class Server extends node_events.EventEmitter {
    port: number;
    host: string;
     ...
     * });
     */
    send(message: Message | Bundle | any[] | string, port: number, host: string, cb?: Function): Promise<void> | undefined;
    /**
